...
function ModulesSection({ isModuleVisible }: { isModuleVisible: (id: keyof SidebarVisibility | undefined) => boolean }) {
  const allModules: Array<{ id: keyof SidebarVisibility; path: string; name: string; desc: string }> = [
    ...
    { id: 'visitas',       path: '/visitas',       name: 'Visitas en Campo',        desc: '6 tipos de acta (previa, instalación, emergencia, normalización, checklist de abastecimiento, formato de comisionamiento) con fotos, GPS, firma certificada, PDF y handoff bidireccional con inventario. Incluye además la Bitácora de Construcción: un registro por casa con múltiples entradas hasta cerrarla.' },
